...
void NVIC_PriorityGroupConfig(uint32_t NVIC_PriorityGroup)
{
  ...
  ((((NVIC_PriorityGroup) == ((uint32_t)0x700)) || ((NVIC_PriorityGroup) == ((uint32_t)0x600)) || ((NVIC_PriorityGroup) == ((uint32_t)0x500)) || ((NVIC_PriorityGroup) == ((uint32_t)0x400)) || ((NVIC_PriorityGroup) == ((uint32_t)0x300))));
...
void NVIC_Init(NVIC_InitTypeDef* NVIC_InitStruct)
{
  ...
  ((((NVIC_InitStruct->NVIC_IRQChannelCmd) == DISABLE) || ((NVIC_InitStruct->NVIC_IRQChannelCmd) == ENABLE)));
...
void NVIC_SetVectorTable(uint32_t NVIC_VectTab, uint32_t Offset)
{
  ...
  ((((NVIC_VectTab) == ((uint32_t)0x20000000)) || ((NVIC_VectTab) == ((uint32_t)0x08000000))));
  (((Offset) < 0x000FFFFF));
...
void NVIC_SystemLPConfig(uint8_t LowPowerMode, FunctionalState NewState)
{
  ...
  ((((LowPowerMode) == ((uint8_t)0x10)) || ((LowPowerMode) == ((uint8_t)0x04)) || ((LowPowerMode) == ((uint8_t)0x02))));
  ((((NewState) == DISABLE) || ((NewState) == ENABLE)));
...
void SysTick_CLKSourceConfig(uint32_t SysTick_CLKSource)
{
  ...
  ((((SysTick_CLKSource) == ((uint32_t)0x00000004)) || ((SysTick_CLKSource) == ((uint32_t)0xFFFFFFFB))));
