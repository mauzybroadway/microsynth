...
// 		
// 		switch(test){
// 			case 1: asm_print_digit(12,test++); break;
// 			case 2: asm_print_digit(0,test++); break;
// 			case 3: asm_print_digit(0,test++); break;
// 			case 4: asm_print_digit(12,4); test = 1; break;
// 			default: test = 1;
// 		}
// 		//printf("asdf\n");
// 		
