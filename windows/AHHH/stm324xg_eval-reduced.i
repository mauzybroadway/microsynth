...
# 36 "./added/stm324xg_eval-reduced.c" 2
...
# 37 "./added/stm324xg_eval-reduced.c" 2
# 1 "./added/misc.h" 1
# 54 "./added/misc.h"
typedef struct
{
...
# 38 "./added/stm324xg_eval-reduced.c" 2
# 1 "./added/stm324xg_eval-reduced.h" 1
# 39 "./added/stm324xg_eval-reduced.h"
# 1 "./added/stm32_eval_legacy.h" 1
# 40 "./added/stm324xg_eval-reduced.h" 2
# 60 "./added/stm324xg_eval-reduced.h"
typedef enum
{
  LED1 = 0,
  LED2 = 1,
...
# 355 "./added/stm324xg_eval-reduced.h"
void STM_EVAL_LEDInit(Led_TypeDef Led);
void STM_EVAL_LEDOn(Led_TypeDef Led);
void STM_EVAL_LEDOff(Led_TypeDef Led);
void STM_EVAL_LEDToggle(Led_TypeDef Led);
# 39 "./added/stm324xg_eval-reduced.c" 2
# 89 "./added/stm324xg_eval-reduced.c"
GPIO_TypeDef* GPIO_PORT[4] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),
                                 ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00))};
const uint16_t GPIO_PIN[4] = {((uint16_t)0x1000), ((uint16_t)0x2000), ((uint16_t)0x4000),
                                 ((uint16_t)0x8000)};
const uint32_t GPIO_CLK[4] = {((uint32_t)0x00000008), ((uint32_t)0x00000008), ((uint32_t)0x00000008),
                                 ((uint32_t)0x00000008)};
# 160 "./added/stm324xg_eval-reduced.c"
NVIC_InitTypeDef NVIC_InitStructure;
# 189 "./added/stm324xg_eval-reduced.c"
void STM_EVAL_LEDInit(Led_TypeDef Led)
{
...
# 217 "./added/stm324xg_eval-reduced.c"
void STM_EVAL_LEDOn(Led_TypeDef Led)
{
  GPIO_PORT[Led]->BSRRL = GPIO_PIN[Led];
}
# 232 "./added/stm324xg_eval-reduced.c"
void STM_EVAL_LEDOff(Led_TypeDef Led)
{
  GPIO_PORT[Led]->BSRRH = GPIO_PIN[Led];
}
# 247 "./added/stm324xg_eval-reduced.c"
void STM_EVAL_LEDToggle(Led_TypeDef Led)
{
