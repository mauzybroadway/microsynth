# 1 "./added/p24.c"
# 1 "C:\\Documents and Settings\\mauzy\\My Documents\\ENEE440\\Project\\AHHH//"
# 1 "<command-line>"
# 1 "./added/p24.c"


# 1 "./added/stm32f4xx_rcc.h" 1
# 37 "./added/stm32f4xx_rcc.h"
...
GPIO_TypeDef* ANCA_PORT[12] = {((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),
                                 ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)),
                 ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)),
                 ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))};
const uint16_t ANCA_PIN[12] = {((uint16_t)0x0020), ((uint16_t)0x0002),
                                 ((uint16_t)0x0002), ((uint16_t)0x0020), ((uint16_t)0x0800),
                 ((uint16_t)0x0004), ((uint16_t)0x0010), ((uint16_t)0x0001), ((uint16_t)0x0002), ((uint16_t)0x0004),
                 ((uint16_t)0x0010), ((uint16_t)0x0800)};
const uint32_t ANCA_CLK[12] = {((uint32_t)0x00000004), ((uint32_t)0x00000002),
                                 ((uint32_t)0x00000001), ((uint32_t)0x00000002), ((uint32_t)0x00000002),
                 ((uint32_t)0x00000004), ((uint32_t)0x00000004), ((uint32_t)0x00000002), ((uint32_t)0x00000004),
                 ((uint32_t)0x00000008), ((uint32_t)0x00000002), ((uint32_t)0x00000004)};
