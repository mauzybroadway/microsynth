...
/*GPIO_TypeDef* AN_PORT[CAn] = {AN_EN_GPIO_PORT, AN_DIGIT1_GPIO_PORT, AN_DIGIT2_GPIO_PORT,
                                 AN_COLON_GPIO_PORT, AN_DIGIT3_GPIO_PORT, AN_DIGIT4_GPIO_PORT,
																 AN_R_GPIO_PORT, AN_G_GPIO_PORT, AN_ROT_ENC_GPIO_PORT,
																 AN_CLK_GPIO_PORT);
const uint16_t AN_PIN[CAn] = {AN_EN_PIN, AN_DIGIT1_PIN, AN_DIGIT2_PIN,
                                 AN_COLON_PIN, AN_DIGIT3_PIN, AN_DIGIT4_PIN,
																 AN_R_PIN, AN_G_PIN, AN_ROT_ENC_PIN,
																 AN_CLK_PIN};
const uint32_t AN_CLK[CAn] = {AN_EN_GPIO_CLK, AN_DIGIT1_GPIO_CLK, AN_DIGIT2_GPIO_CLK,
                                 AN_COLON_GPIO_CLK, AN_DIGIT3_GPIO_CLK, AN_DIGIT4_GPIO_CLK,
																 AN_R_GPIO_CLK, AN_G_GPIO_CLK, AN_ROT_ENC_GPIO_CLK,
																 AN_CLK_GPIO_CLK);*/
...
// !!wmh (single line commented block below)  
