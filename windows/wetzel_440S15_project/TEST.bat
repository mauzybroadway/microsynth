...
REM	We will attempt to shrink it by allowing garbage collection -- did't appear to do anything
REM	We will increase optimization to -O2 -- something is wrong, we are not getting _any_size reduction for either --gc or -O2
REM	
...
REM assemble startup code 
   cd added
   arm-none-eabi-as -g -mcpu=cortex-m4 STM32F4_P24v04.asm -o ..\aDemo.o
   arm-none-eabi-as -g -mcpu=cortex-m4 SimpleStartSTM32F4_03a.asm -o ..\aStartup.o
   arm-none-eabi-as -g -mcpu=cortex-m4 DMA1Stream5int_svc.asm -o ..\aDacStream.o
   cd ..


REM compile C support
   arm-none-eabi-gcc -I./added -fdata-sections -ffunction-sections  -c -mthumb -O2 -g -mcpu=cortex-m4 -save-temps -D STM32F40_41xxx -D USE_STM324xG_EVAL ./added/stm32f4xx_tim.c -o tim.o
...
REM compile application
  arm-none-eabi-gcc -I./added -fdata-sections -ffunction-sections  -c -mthumb -O2 -g -mcpu=cortex-m4 -save-temps -D STM32F40_41xxx -D USE_STM324xG_EVAL main.c -o cMain.o
  arm-none-eabi-gcc -I./added  -c -mthumb -O2 -fdata-sections -ffunction-sections -g -mcpu=cortex-m4 -save-temps -D STM32F40_41xxx -D USE_STM324xG_EVAL stm32f4xx_it.c -o Cit.o
  arm-none-eabi-gcc -I./added  -c -mthumb -O2 -fdata-sections -ffunction-sections -g -mcpu=cortex-m4 -save-temps -D STM32F40_41xxx -D USE_STM324xG_EVAL system_stm32f4xx.c -o Csystem.o

REM linking
  arm-none-eabi-gcc -nostartfiles -g -Wl,--gc-sections -Wl,-Map,Blinky.map -Wl,-T linkBlinkySTM32F4_01.ld -oBlinky.elf aStartup.o aDemo.o aDacStream.o cMain.o Cit.o Csystem.o tim.o rcc.o gpio.o misc.o eval.o p24.o -lgcc 
